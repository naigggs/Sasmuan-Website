...
function Hero_BangkungMalapad() {
  return (
    <div className="Inter relative bg-HeroImageBangkungMalapad bg-cover bg-hero border-b-2 border-[#02bbbd]">
...
export default Hero_BangkungMalapad;
